...
public class Outline : MonoBehaviour
{
	...
	{
		IEnumerable<IGrouping<Vector3, KeyValuePair<Vector3, int>>> enumerable = mesh.vertices.Select((Vector3 vertex, int index) => new KeyValuePair<Vector3, int>(vertex, index)).GroupBy(delegate(KeyValuePair<Vector3, int> pair)
		{
			KeyValuePair<Vector3, int> keyValuePair = pair;
